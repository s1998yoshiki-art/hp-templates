...
// 仲里歯科医院 デモサイト 共通定数
// ※公開情報（公式サイト nakazatoshika.com・ドクターズ・ファイル・メディカルドック等）から
...
export const SITE = {
  ...
  officialUrl: "https://nakazatoshika.com/",
};
